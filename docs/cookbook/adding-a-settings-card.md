...
import type {} from '@unieai/uad-client-ui-settings-plugins/client'
...
```jsonc
{
  ...
  "dsh": { "client": { "platform": "web", "inject": ["@unieai/uad-client-ui-settings-plugins"] } }
}
```
...
export default clientBundle('@unieai/uad-client-my-plugin', ['lib/types/index.js', 'lib/types/invariant.js'])
```
