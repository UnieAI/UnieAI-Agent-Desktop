...
Source: [`packages/unieai/web-gate/src/index.ts:165`](../packages/unieai/web-gate/src/index.ts)
...
- `@unieai/uad-workspace` — requires `storageDomain` · `sessionPersistence` · `fs` ([`packages/workspace/workspace/src/index.ts`](../packages/workspace/workspace/src/index.ts))
