...
`pnpm dsh web` prints the URL it bound and opens a browser. Pass `--no-open` to keep it in the terminal, and `--port <n>` to choose the port instead of the default 3080.
