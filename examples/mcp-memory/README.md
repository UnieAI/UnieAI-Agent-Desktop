...
```sh
uad web --patch "$PWD/examples/mcp-memory/memorix.cordis.yml"
```
...
uad web --patch "$PWD/examples/mcp-memory/mcp-reference-memory.cordis.yml"
```
...
uad web --patch "$PWD/examples/mcp-memory/engram.cordis.yml"
```
