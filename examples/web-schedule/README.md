...
This overlay opts one `rabi web` process into Schedule reminders without changing the shipped default Web composition:

```sh
rabi web --patch examples/web-schedule/cordis.yml
```
