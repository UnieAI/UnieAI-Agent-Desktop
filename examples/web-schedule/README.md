...
This overlay opts one `uad web` process into Schedule reminders without changing the shipped default Web composition:

```sh
uad web --patch examples/web-schedule/cordis.yml
```
