...
import { boot, loadOverlayPatches } from '@unieai/uad-app-boot'
import SystemPrompt from '@unieai/uad-system-prompt'
import ToolRuntime from '@unieai/uad-tools'
import * as McpClient from '@unieai/uad-mcp-client/src/index.ts'
...
describe('third-party memory MCP example overlays', () => {
  it.each(examples)('parses $file with the documented generic plugin fields', (contract) => {
    ...
    expect(row.name).toBe('@unieai/uad-mcp-client')
