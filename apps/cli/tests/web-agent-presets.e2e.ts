...
import { boot, healProfilesModuleFallback, loadOverlayPatches, loadProfile } from '@unieai/uad-app-boot'
...
import type { PatchOptions } from '@unieai/cordis-plugin-include'
import { afterAll, beforeAll, describe, expect, it, vi } from 'vitest'
import { settingsNamespace } from '@unieai/uad-settings'
import { resolveSessionPreset, SETTINGS_NAMESPACE } from '@unieai/uad-agent-presets'
import { applyChildComposition, childSessionMeta } from '@unieai/uad-subagent'
import { CallId } from '@unieai/uad-llm'
import type {} from '@unieai/uad-compaction-basic'
...
import type {} from '@unieai/uad-token-meter'
