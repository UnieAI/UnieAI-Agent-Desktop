...
- id: delegation
  ...
  config:
    - id: workflow-worker-thread
      name: '@unieai/uad-workflow-worker-thread'
      config:
        provider: spawn
    - id: tool-workflow
      name: '@unieai/uad-tool-workflow'
```
