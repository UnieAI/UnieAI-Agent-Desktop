...
import { bootInjections, orderByModuleGraph } from '@unieai/uad-client-modules'
import type { ClientModuleLoaderTarget, WebBootEntry } from '@unieai/uad-client-modules/client'
...
const appBoot = await import(pathToFileURL(webBundleResolver.resolve('@unieai/uad-app-boot')).href) as unknown as BootComposition
