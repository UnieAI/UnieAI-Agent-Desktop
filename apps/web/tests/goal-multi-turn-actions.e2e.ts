...
import { parseSessionLog } from '@unieai/uad-llm-replay'
import type { SessionEvent, SessionId } from '@unieai/uad-session'
import type {} from '@unieai/uad-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@unieai/uad-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@unieai/uad-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@unieai/uad-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@unieai/uad-skill-filesystem"}\n',
