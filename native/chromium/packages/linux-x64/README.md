# @unieai/rabi-chromium-linux-x64

English | [中文](README.zh.md)

The open-source Chromium build for **Linux on x86-64**, carried so the operator browser works on a machine that has no browser of its own.

Chromium snapshot revision: `1685233` — BSD-3-Clause, and the LICENSE beside the payload is the text it is published under.
