# @unieai/rabi-chromium-darwin-x64

English | [中文](README.zh.md)

The open-source Chromium build for **macOS on Intel**, carried so the operator browser works on a machine that has no browser of its own.
