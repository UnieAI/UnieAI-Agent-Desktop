...
DeepSeek Harness (`uad`) is an open-source agent harness developed by [DeepSeek AI](https://deepseek.com).
...
`pnpm run build` prepares the repository artifacts. `pnpm uad web` uses those built artifacts without rebuilding.
