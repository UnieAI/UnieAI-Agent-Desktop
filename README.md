...
DeepSeek Harness (`rabi`) is an open-source agent harness developed by [DeepSeek AI](https://deepseek.com).
...
`pnpm run build` prepares the repository artifacts. `pnpm rabi web` uses those built artifacts without rebuilding.
