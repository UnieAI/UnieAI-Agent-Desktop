/**
 * Package-owned invariant companion for `@unieai/uad-output-retention`.
 * @module @unieai/uad-output-retention/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-output-retention'
