/**
 * Package-owned invariant companion for `@unieai/uad-agent-spine-demo`.
 * @module @unieai/uad-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-agent-spine-demo'
