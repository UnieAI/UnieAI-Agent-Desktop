 ...
 * ({@link @unieai/uad-agent-spine-demo}), JSONL session persistence, and
 * the {@link @unieai/uad-acp} bridge. The app owns those plugins through one
 ...
 * @module @unieai/uad-acp-demo
 */

import type { Context } from '@unieai/cordis'
import { join } from 'node:path'
import z from '@unieai/schemastery'
import * as acp from '@unieai/uad-acp'
import * as agentCore from '@unieai/uad-agent-spine-demo'
...
} from '@unieai/uad-session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@unieai/uad-session-checkpoint-policy'
