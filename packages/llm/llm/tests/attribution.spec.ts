...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@unieai/uad-llm'
import type { AppIdentity } from '@unieai/uad-llm'
...
describe('userAgent', () => {
  it('renders product/version with the +url comment', () => {
    expect(userAgent()).toBe(
      `deepseek-harness/${manifest.version} (+https://github.com/unieai/deepseek-harness)`,
    )
  })
