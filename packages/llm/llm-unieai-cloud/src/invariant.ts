/**
 * Package-owned invariant companion for `@unieai/uad-llm-unieai-cloud`.
 * @module @unieai/uad-llm-unieai-cloud/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-llm-unieai-cloud'
