...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('workspace-listing-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('connectors-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('connector-refused'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('machines-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('machine-unknown'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('machine-edit-refused'), message: z.string(), details: z.object({}) }),
  ...
  z.object({ code: z.literal('workspace-file-stale'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('browser-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('browser-disabled'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('browser-no-browser'), message: z.string(), details: z.object({ browserId: z.string() }) }),
  z.object({ code: z.literal('browser-no-chrome'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('browser-too-many-browsers'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('browser-closed'), message: z.string(), details: z.object({ browserId: z.string() }) }),
  z.object({ code: z.literal('browser-blocked-url'), message: z.string(), details: z.object({ url: z.string() }) }),
  z.object({ code: z.literal('terminal-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('terminal-disabled'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('terminal-no-terminal'), message: z.string(), details: z.object({ terminalId: z.string() }) }),
  z.object({ code: z.literal('terminal-too-many-terminals'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('terminal-no-shell'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('terminal-exited'), message: z.string(), details: z.object({ terminalId: z.string() }) }),
