...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@unieai/uad-attachment'
import type { ContentBlock } from '@unieai/uad-llm/types'
import type { SessionEvent, SessionId } from '@unieai/uad-session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via dsh-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@unieai/uad-session-projection/types'
