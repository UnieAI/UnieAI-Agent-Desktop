 ...
 * @module @unieai/uad-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@unieai/uad-host-directory-picker-native',
  browse: '@unieai/uad-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@unieai/uad-client-ui-directory-picker-native',
  browse: '@unieai/uad-client-ui-directory-picker-browse',
}
