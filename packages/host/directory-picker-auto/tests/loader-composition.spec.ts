...
import HttpServer from '@unieai/uad-host-webserver'
import type { DirectoryPicker } from '@unieai/uad-host-directory-picker'
import BrowseDirectoryPicker from '@unieai/uad-host-directory-picker-browse'
import NativeDirectoryPicker from '@unieai/uad-host-directory-picker-native'
...
const AUTO = '@unieai/uad-host-directory-picker-auto'
const NATIVE = '@unieai/uad-host-directory-picker-native'
const BROWSE = '@unieai/uad-host-directory-picker-browse'
const NATIVE_SURFACE = '@unieai/uad-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@unieai/uad-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  await writeFile(configPath, [
    "- name: '@unieai/uad-host-webserver'",
    '  config:',
    `    host: '${bindHost}'`,
    '    port: 0',
    `- name: '${AUTO}'`,
  ...
  const modules = new Map<string, unknown>([
    ['@unieai/uad-host-webserver', HttpServer],
