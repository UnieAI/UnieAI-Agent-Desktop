/** Package-owned invariant companion for the directory-picker seam. @module @unieai/uad-host-directory-picker/invariant */

import type { Context } from '@unieai/cordis'
import type { InvariantInstaller } from '@unieai/uad-invariants'

const PACKAGE_NAME = '@unieai/uad-host-directory-picker'
