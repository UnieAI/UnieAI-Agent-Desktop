 ...
 *
 * @module @unieai/uad-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@unieai/node-addon-landlock-run'
 ...
 * (`@unieai/uad-fs-sandbox`) can never drift apart.
