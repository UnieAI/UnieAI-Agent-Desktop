...
import { LAUNCHER_FAILURE_EXIT } from '@unieai/node-addon-landlock-run'
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@unieai/uad-sandbox'
import type { SandboxPolicy } from '@unieai/uad-sandbox'
import {
  LocalSandboxProvider,
} from '@unieai/uad-sandbox-local'
import type { Config } from '@unieai/uad-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @unieai/uad-sandbox-windows-acl/tests/provider-chain.spec.ts
