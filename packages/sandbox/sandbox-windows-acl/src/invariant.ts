/**
 * Package-owned invariant companion for `@unieai/uad-sandbox-windows-acl`.
 * @module @unieai/uad-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-sandbox-windows-acl'
