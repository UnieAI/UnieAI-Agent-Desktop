 ...
 * runtime over stdio JSON-RPC through `@unieai/uad-sdk-client` and owns
 * cancellation and quiescent disposal. Structure mirrors the ACP backend
 * (`@unieai/uad-subagent-acp`): publish after the child handshake,
 ...
 *
 * @module @unieai/uad-subagent-dsh-sdk/run
 */

import { randomUUID } from 'node:crypto'
import { DeepSeekHarness, type HarnessNotification } from '@unieai/uad-sdk-client'
import type { ContentBlock } from '@unieai/uad-llm'
import { SessionId, type SessionEvent, type TurnEndReason } from '@unieai/uad-session'
import type { SubagentResult, SubagentRun, SubagentStartRequest, SubagentStopReason } from '@unieai/uad-subagent'
import { AssistantOutputFold, settleRunResult, subprocessRunHandle } from '@unieai/uad-subagent'
