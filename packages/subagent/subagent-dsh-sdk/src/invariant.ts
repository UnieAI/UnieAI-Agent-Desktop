/**
 * Package-owned invariant companion for `@unieai/uad-subagent-dsh-sdk`.
 * @module @unieai/uad-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-subagent-dsh-sdk'
