 ...
 * @module @unieai/uad-subagent-dsh-sdk
 */

import type { Context } from '@unieai/cordis'
import z from '@unieai/schemastery'
import type { SubagentCapabilities, SubagentProvider, SubagentStartRequest } from '@unieai/uad-subagent'
import { assertPositiveFinite, NO_START_CAPABILITIES, resolveChildCwd, validateConfiguredCwd } from '@unieai/uad-subagent'
import {
