/**
 * Package-owned invariant companion for `@unieai/uad-tool-subagent-report`.
 * @module @unieai/uad-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-tool-subagent-report'
