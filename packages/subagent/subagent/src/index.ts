 ...
 * (`@unieai/uad-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@unieai/uad-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@unieai/uad-tools'
import type { ContentBlock, MessageId } from '@unieai/uad-llm'
