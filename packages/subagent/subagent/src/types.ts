 ...
 *
 * @module @unieai/uad-subagent/types
 */

import type { Agent, AgentOptions } from '@unieai/uad-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@unieai/uad-tools'
