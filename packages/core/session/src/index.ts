 ...
 *
 * @module @unieai/uad-session
 */

import { Context, Service } from '@unieai/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@unieai/uad-llm'
import { scopeOf, scopeTarget } from '@unieai/uad-scope'
import type { Scoped } from '@unieai/uad-scope'
import type { Message } from '@unieai/uad-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@unieai/uad-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@unieai/uad-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@unieai/uad-session#Session',
        wireTypeSymbol: '@unieai/uad-session/types#SessionId',
