 ...
 *
 * @module @unieai/uad-agent
 */

import { Context, FiberState, getTraceable, Service, symbols } from '@unieai/cordis'
...
import type { TypertContext, TypertLookup } from '@unieai/uad-typert-protocol'
 ...
 * (`@unieai/uad-agent-loop`), registered via {@link setFactory}.
 *
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('agent', {
        parameter: 'agent',
        wire: 'agentId',
        hostTypeSymbol: '@unieai/uad-agent#Agent',
