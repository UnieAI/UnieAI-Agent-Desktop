...
import { createScope, scopeOf } from '@unieai/uad-scope'
import type { Scope, ScopeKey } from '@unieai/uad-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@unieai/uad-system-prompt'
import type { Config, PromptAssembly } from '@unieai/uad-system-prompt'
