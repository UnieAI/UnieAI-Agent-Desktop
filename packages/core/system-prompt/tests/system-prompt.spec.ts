...
import SystemPrompt, { AssembleContext, PromptAssembly, renderContextSnapshot, renderPrompt } from '@unieai/uad-system-prompt'
...
const IDENTITY = 'You are an AI agent powered by Rabi.'
