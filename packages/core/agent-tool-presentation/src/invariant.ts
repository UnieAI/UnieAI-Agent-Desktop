/**
 * Package-owned invariant companion for `@unieai/uad-agent-tool-presentation`.
 * @module @unieai/uad-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-agent-tool-presentation'
