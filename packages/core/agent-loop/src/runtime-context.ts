 ...
 * @module @unieai/uad-agent-loop/runtime-context
 */

import { createUserMessage } from '@unieai/uad-llm'
import type { ContextSnapshotSection } from '@unieai/uad-llm'
import type { Session, UserMessage } from '@unieai/uad-session'
import { isReplacementSurfaceEvent } from '@unieai/uad-session'
import type { Context } from '@unieai/cordis'

const SOURCE = '@unieai/uad-system-prompt'
