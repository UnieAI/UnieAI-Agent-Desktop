/**
 * Package-owned invariant companion for `@unieai/uad-storage-domain`: every
 ...
 * @module @unieai/uad-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-storage-domain'
