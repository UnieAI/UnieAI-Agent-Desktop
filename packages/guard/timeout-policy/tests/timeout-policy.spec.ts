/**
 * Unit + real-load-path coverage for @unieai/uad-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@unieai/uad-llm'
import SystemPrompt from '@unieai/uad-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@unieai/uad-tools'
import * as timeoutPolicy from '@unieai/uad-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@unieai/uad-tool-call-timeout-policy'
