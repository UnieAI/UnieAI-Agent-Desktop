/**
 * Package-owned invariant companion for `@unieai/uad-tool-call-timeout-policy`.
 * @module @unieai/uad-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-tool-call-timeout-policy'
