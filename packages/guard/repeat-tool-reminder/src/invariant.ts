/**
 * Package-owned invariant companion for `@unieai/uad-repeat-tool-reminder`.
 * @module @unieai/uad-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-repeat-tool-reminder'
