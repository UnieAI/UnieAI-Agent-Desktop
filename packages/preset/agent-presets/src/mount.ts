 ...
 * @module @unieai/uad-agent-presets/mount
 */
...
import type { EntryTree } from '@unieai/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@unieai/uad-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@unieai/uad-*` row would fail to import. The
