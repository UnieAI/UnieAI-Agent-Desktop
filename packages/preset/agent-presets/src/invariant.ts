/**
 * Package-owned invariant companion for `@unieai/uad-agent-presets`.
 * @module @unieai/uad-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@unieai/uad-agent-presets'

const PACKAGE_NAME = '@unieai/uad-agent-presets'
