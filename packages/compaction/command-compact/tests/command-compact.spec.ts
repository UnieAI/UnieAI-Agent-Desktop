...
import CommandRuntime, { type CommandResult } from '@unieai/uad-commands'
import {
  CompactionId,
  CompactionEngine,
...
import * as commandCompact from '@unieai/uad-command-compact'
...
describe('@unieai/uad-command-compact registration', () => {
