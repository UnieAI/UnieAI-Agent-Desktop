/**
 * Package-owned invariant companion for `@unieai/uad-command-compact`.
 * @module @unieai/uad-command-compact/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-command-compact'
