/**
 * Package-owned invariant companion for `@unieai/uad-compaction-tool-result-pruner`.
 * @module @unieai/uad-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-compaction-tool-result-pruner'
