 ...
 *
 * The seam itself lives in `@unieai/uad-compaction`, which re-exports these
 ...
 *
 * @module @unieai/uad-compaction/checkpoint
 */

import type { MessageSource } from '@unieai/uad-llm/message'
