/**
 * Package-owned invariant companion for `@unieai/uad-session-query-sqlite`.
 * @module @unieai/uad-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-session-query-sqlite'
