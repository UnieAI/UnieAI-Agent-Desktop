/**
 * Package-owned invariant companion for `@unieai/uad-tool-session-query`.
 * @module @unieai/uad-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-tool-session-query'
