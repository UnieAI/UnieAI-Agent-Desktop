 ...
 * @module @unieai/uad-cordis-host-runner/guard
 */

import { Context } from '@unieai/cordis'
import type { Plugin } from '@unieai/cordis'
import { scopeOf } from '@unieai/uad-scope'
import { assertSupportedJsonSchema, defineTool } from '@unieai/uad-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@unieai/uad-cordis-client-runner`, whose CTX_VERBS names this one its
