/**
 * Package-owned invariant companion for `@unieai/uad-cordis-host-runner`.
 * @module @unieai/uad-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-cordis-host-runner'
