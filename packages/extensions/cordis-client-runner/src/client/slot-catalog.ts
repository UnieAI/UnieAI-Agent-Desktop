...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'details\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-studio-sources StudioSources id \'studio-kb-sources\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.details.tool.annotation\', () => ctx.slots.register(\n      { name: \'conversation.details.tool.annotation\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-machines MachineControl id \'machine\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.input.chrome.end\', () => ctx.slots.register(\n      { name: \'conversation.input.chrome.end\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:317',
  },
  {
  ...
  {
    key: 'conversation.session.header.gauges',
    kind: 'list',
    scope: 'session',
    summary: 'Continuous readings about the session\'s surroundings, drawn immediately BEFORE the view switch: a gauge describes the machine the work happens on, and the switch names what the column is showing, so a reading that appeared after the switch would read as a property of the view.',
    doc: 'Continuous readings about the session\'s surroundings, drawn immediately\nBEFORE the view switch: a gauge describes the machine the work happens\non, and the switch names what the column is showing, so a reading that\nappeared after the switch would read as a property of the view.\n\nA list rather than a single seat, because a deployment may want more\nthan one reading and their order is `order`, not registration.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-machine-gauges MachineGauges id \'machine-gauges\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.session.header.gauges\', () => ctx.slots.register(\n      { name: \'conversation.session.header.gauges\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'document\', () => ctx.slots.register(\n      { name: \'document\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-plugins-page StudioEntry id \'unieai-studio\'',
  ...
  {
    key: 'settings.models.account',
    kind: 'list',
    scope: 'root',
    summary: 'An account-owned provider list inside the Models page (see module JSDoc).',
    doc: 'An account-owned provider list inside the Models page (see module JSDoc).',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'settings.models.account\', () => ctx.slots.register(\n      { name: \'settings.models.account\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-settings-models/src/client/slot-contract.ts:24',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-connectors ConnectorsSection id \'connectors\'',
