/**
 * Package-owned invariant companion for `@unieai/uad-cordis-client-runner`.
 * @module @unieai/uad-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-cordis-client-runner'
