/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-cordis`.
 * @module @unieai/uad-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-cordis'
