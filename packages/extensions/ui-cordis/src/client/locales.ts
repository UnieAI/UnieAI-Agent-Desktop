...
/** Traditional Chinese Cordis UI messages. */
export const zhTW = {
  ...
  'status.superseded': '已有更新',
  'run.removed': '套件已不存在',
  'run.superseded': '已有更新的執行卡片，請看下方',
  'panel.hint': '執行控制項位於左下角設定上方的 Cordis 面板',
  'panel.plugins.aria': 'Cordis 外掛',
  'panel.approvals.aria': 'Cordis 審核',
  'panel.trigger': 'Cordis Plugin',
  'panel.runningCount': '{count} 個執行中',
  'panel.title': 'Cordis 外掛',
  'panel.empty': '尚未定義任何外掛',
  'panel.loading': '讀取中…',
  ...
  'action.retry': '重試',
  'action.rollback': '還原',
  'render.failedAbdicated': '{slot} 渲染失敗，已還原為預設介面：',
...
export const ja = {
  ...
  'render.failedAbdicated': '{slot} のレンダリングに失敗したため、既定の UI に戻しました:',
