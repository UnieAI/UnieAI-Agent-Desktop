...
import type {} from '@unieai/uad-client-ui-tool/client'
...
import type { InputTriggerService, InputTriggerSource } from '@unieai/uad-client-ui-input-trigger/client'
...
import { en, ja, NS, zh, zhTW } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => ctx.locale.register(NS, { 'zh-CN': zh, 'zh-TW': zhTW, ja, en }), 'ui-cordis: dictionaries')
