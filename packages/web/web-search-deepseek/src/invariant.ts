/**
 * Package-owned invariant companion for `@unieai/uad-web-search-deepseek`.
 * @module @unieai/uad-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-web-search-deepseek'
