/**
 * `@unieai/uad-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@unieai/uad-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@unieai/uad-web`.
 *
 * @module @unieai/uad-web-search-exa
 */

import type { Context } from '@unieai/cordis'
import { launchEnvironmentOf } from '@unieai/uad-launch-environment'
import z from '@unieai/schemastery'
import type {} from '@unieai/uad-web'
import {
  ExaSearchProvider,
