...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@unieai/uad-tools'
import type { WebFetchBody, WebFetchResult } from '@unieai/uad-web'
 ...
 * `@unieai/uad-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@unieai/uad-tool-call-timeout-policy` to enforce.
