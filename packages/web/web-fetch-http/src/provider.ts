 ...
 * `@unieai/uad-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @unieai/uad-web-fetch-http/provider
 */

import { WebError } from '@unieai/uad-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@unieai/uad-web'
