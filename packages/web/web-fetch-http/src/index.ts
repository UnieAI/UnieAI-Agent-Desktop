/**
 * `@unieai/uad-web-fetch-http`: registers an anonymous public HTTP(S)
 ...
 *
 * @module @unieai/uad-web-fetch-http
 */
...
export const DEFAULT_USER_AGENT = 'deepseek-harness/0.0.1 (+https://github.com/unieai)'
