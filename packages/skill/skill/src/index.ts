 ...
 * Concrete
 * providers such as `@unieai/uad-skill-filesystem` decide where skills come
 ...
 *
 * @module @unieai/uad-skill
 */

import { Context, Service } from '@unieai/cordis'
import { assertNever } from '@unieai/uad-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@unieai/uad-scope'
