/** JSON string-prefix accounting for the outer-output ledger. @module @unieai/uad-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@unieai/uad-code-runtime'
