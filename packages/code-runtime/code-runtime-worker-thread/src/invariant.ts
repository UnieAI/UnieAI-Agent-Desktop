/**
 * Package-owned invariant companion for `@unieai/uad-code-runtime-worker-thread`.
 * @module @unieai/uad-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-code-runtime-worker-thread'
