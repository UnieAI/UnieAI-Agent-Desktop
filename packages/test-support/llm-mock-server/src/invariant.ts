/**
 * Package-owned invariant companion for `@unieai/uad-llm-mock-server`.
 * @module @unieai/uad-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-llm-mock-server'
