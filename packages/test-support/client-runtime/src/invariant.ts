/**
 * Package-owned invariant companion for `@unieai/uad-client-test-runtime`.
 * @module @unieai/uad-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-test-runtime'
