/**
 * Package-owned invariant companion for `@unieai/uad-agent-loop-testkit`.
 * @module @unieai/uad-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-agent-loop-testkit'
