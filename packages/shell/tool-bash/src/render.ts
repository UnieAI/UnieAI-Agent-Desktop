 ...
 *
 * @module @unieai/uad-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@unieai/uad-shell'
import type { SandboxMode } from '@unieai/uad-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@unieai/uad-sandbox'
 ...
 * rendering story, owned by `@unieai/uad-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@unieai/uad-shell'
