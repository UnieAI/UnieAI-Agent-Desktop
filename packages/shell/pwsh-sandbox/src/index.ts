 ...
 * `@unieai/uad-bash-sandbox`. It wraps the exact local pwsh argv through
...
import type {
  ...
  SandboxMode,
  SandboxPolicy,
} from '@unieai/uad-sandbox'
import type {} from '@unieai/uad-sandbox-policy'
import { PwshLocalExecutor } from '@unieai/uad-pwsh-local'
import type { Config as LocalConfig } from '@unieai/uad-pwsh-local'
