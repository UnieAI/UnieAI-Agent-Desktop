/**
 * Real-process tests for `@unieai/uad-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@unieai/uad-pwsh-local'
import LocalSubprocessRuntime from '@unieai/uad-subprocess-local'
import SubprocessRuntime from '@unieai/uad-subprocess'
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@unieai/uad-subprocess'
import { MAX_TIMER_DELAY_MS } from '@unieai/uad-timeout'
import type { ShellProcess } from '@unieai/uad-shell'
