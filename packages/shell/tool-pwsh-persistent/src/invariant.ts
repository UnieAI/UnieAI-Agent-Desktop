/**
 * Package-owned invariant companion for `@unieai/uad-tool-pwsh-persistent`.
 * @module @unieai/uad-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-tool-pwsh-persistent'
