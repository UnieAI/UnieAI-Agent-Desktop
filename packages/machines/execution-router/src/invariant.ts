/**
 * Package-owned invariant companion for `@unieai/uad-execution-router`.
 * @module @unieai/uad-execution-router/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-execution-router'

/** Cordis companion plugin name. */
export const name = 'execution-router-invariant'
