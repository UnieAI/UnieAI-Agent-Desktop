 ...
 * @module @unieai/uad-session-persistence
 */

import { Context, Service } from '@unieai/cordis'
import { SessionPreparation } from '@unieai/uad-session'
import type { SessionEvent, SessionId, SessionHeader } from '@unieai/uad-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@unieai/uad-session'
