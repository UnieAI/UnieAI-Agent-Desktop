/**
 * Package-owned invariant companion for `@unieai/uad-session-persistence`.
 * @module @unieai/uad-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-session-persistence'
