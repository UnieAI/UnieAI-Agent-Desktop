/**
 * Package-owned invariant companion for `@unieai/uad-session-projection`.
 * @module @unieai/uad-session-projection/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-session-projection'
