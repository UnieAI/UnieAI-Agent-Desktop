/**
 * Package-owned invariant companion for `@unieai/uad-session-persistence-jsonl`.
 * @module @unieai/uad-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-session-persistence-jsonl'
