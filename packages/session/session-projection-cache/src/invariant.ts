/**
 * Package-owned invariant companion for `@unieai/uad-session-projection-cache`.
 * @module @unieai/uad-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-session-projection-cache'
