/**
 * Package-owned invariant companion for `@unieai/uad-session-telemetry-otel`.
 * @module @unieai/uad-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-session-telemetry-otel'
