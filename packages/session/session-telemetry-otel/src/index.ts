 ...
 *
 * @module @unieai/uad-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@unieai/schemastery'
import type { Context } from '@unieai/cordis'
import type {} from '@unieai/uad-command-feedback'
import {
...
} from '@unieai/uad-session-telemetry'
import { APP_IDENTITY } from '@unieai/uad-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@unieai/uad-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@unieai/uad-session-telemetry-otel/ops', version)
