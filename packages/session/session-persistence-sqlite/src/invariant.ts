/**
 * Package-owned invariant companion for `@unieai/uad-session-persistence-sqlite`.
 * @module @unieai/uad-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-session-persistence-sqlite'
