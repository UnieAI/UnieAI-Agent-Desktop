/**
 * Package-owned invariant companion for `@unieai/uad-session-title-first-prompt-llm`.
 * @module @unieai/uad-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-session-title-first-prompt-llm'
