 ...
 * @module @unieai/uad-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@unieai/cordis'
import z from '@unieai/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@unieai/uad-brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@unieai/uad-llm'
import type { GenerateOptions } from '@unieai/uad-llm'
import type {
  Session,
  SessionEvent,
