/**
 * Package-owned invariant companion for `@unieai/uad-session-title-all-prompts-llm`.
 * @module @unieai/uad-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-session-title-all-prompts-llm'
