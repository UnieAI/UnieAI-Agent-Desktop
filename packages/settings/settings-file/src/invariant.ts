/**
 * Package-owned invariant companion for `@unieai/uad-settings-file`.
 * @module @unieai/uad-settings-file/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-settings-file'
 ...
 * tests; the in-process commit relation is owned by `@unieai/uad-settings`.
 */
