/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-theme`.
 * @module @unieai/uad-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-theme'
