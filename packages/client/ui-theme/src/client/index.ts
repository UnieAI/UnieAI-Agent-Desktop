...
import type { BoundActions } from '@unieai/uad-client-ui-slots'
import type { ClientContext, SettingsScope } from '@unieai/uad-client-runtime/client'
...
import { en, ja, zh, zhTW, type ThemeKey } from './locales.ts'
import {
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(SETTINGS_NS, { 'zh-CN': zh, 'zh-TW': zhTW, ja, en }), 'ui-theme: settings row dictionaries')
