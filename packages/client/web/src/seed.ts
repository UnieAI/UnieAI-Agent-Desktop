...
import * as Cordis from '@unieai/cordis'
import * as UiSlots from '@unieai/uad-client-ui-slots'
import * as UiPrimitives from '@unieai/uad-client-ui-primitives'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@unieai/cordis': Cordis,
    '@unieai/uad-client-ui-slots': UiSlots,
    '@unieai/uad-client-ui-primitives': UiPrimitives,
