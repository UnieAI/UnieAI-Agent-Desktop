 ...
 * @module @unieai/uad-client-web/src/boot
 */
import { Context } from '@unieai/cordis'
import Loader from '@unieai/cordis-plugin-loader'
import type {
  BootManifest, ClientModuleCreateOptions, ClientModuleSystem, DshWindow,
} from '@unieai/uad-client-modules/client'
import type {} from '@unieai/uad-client-ui-renderer/client'
...
export class AppWebEntry {
  ...
  async run(): Promise<void> {
    try {
      ...
      // is `ClientTransportHooks`, owned by @unieai/uad-client-connection;
