/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-model-selection`.
 * @module @unieai/uad-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-model-selection'
