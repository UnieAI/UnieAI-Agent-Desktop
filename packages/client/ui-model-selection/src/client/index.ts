...
import type { ModelSelection, SessionModels } from '@unieai/uad-api-remotes/client'
...
import { en, ja, zh, zhTW, type ModelKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => ctx.locale.register(NS, { 'zh-CN': zh, 'zh-TW': zhTW, ja, en }), 'ui-model-selection: dictionaries')
