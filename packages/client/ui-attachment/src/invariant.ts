/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-attachment`.
 * @module @unieai/uad-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-attachment'
