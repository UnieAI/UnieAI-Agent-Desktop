/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-settings-plugins`.
 * @module @unieai/uad-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-settings-plugins'
