/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-skill`.
 * @module @unieai/uad-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-skill'
