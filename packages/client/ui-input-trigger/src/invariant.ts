/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-input-trigger`.
 * @module @unieai/uad-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-input-trigger'
