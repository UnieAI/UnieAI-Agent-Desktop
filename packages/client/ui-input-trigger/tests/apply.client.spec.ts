...
import { createScope, scopeOf, SlotRegistry } from '@unieai/uad-client-runtime/client'
import type { SessionId } from '@unieai/uad-client-runtime/client'
import { apply, inject, InputTriggerService } from '@unieai/uad-client-ui-input-trigger/client'
import type { MenuViewInjected } from '@unieai/uad-client-ui-input-trigger/client'
