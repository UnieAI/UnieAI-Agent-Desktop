...
import { apply, inject, refreshIfLoaded } from '@unieai/uad-client-ui-settings-models/client'
import {
...
describe('ui-settings-models apply', () => {
  ...
  it('registers the models nav entry for declarations before or after apply', async () => {
    ...
    // The welcome notice is the only first-run step this plugin owns: Rabi
    // provisions models from the signed-in account, so no API-key dialog
    // stands between a new user and their first message.
