/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-settings-models`.
 * @module @unieai/uad-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-settings-models'
