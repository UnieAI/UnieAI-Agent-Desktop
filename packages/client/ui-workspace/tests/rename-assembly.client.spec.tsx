...
import type { ISession, SessionId, WorkspaceId } from '@unieai/uad-client-runtime/client'
import type { PropsRenderSlots } from '@unieai/uad-client-ui-slots'
import { SlotTestRuntime, usePinnedBrowserLanguages } from '@unieai/uad-client-test-runtime'
import { LocaleRuntime } from '@unieai/uad-client-locale/client'
import { apply, inject } from '@unieai/uad-client-ui-workspace/client'
...
function SidebarFrame({ renderSlot }: FrameProps) {
  return <>{renderSlot('sidebar.workspaces', { wide: true, expandSidebar: () => {}, searchRequest: 0 })}</>
}
