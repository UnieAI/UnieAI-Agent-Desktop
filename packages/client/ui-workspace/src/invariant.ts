/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-workspace`.
 * @module @unieai/uad-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-workspace'
