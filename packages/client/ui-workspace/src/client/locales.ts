...
export const en = {
  ...
  'groupBy.workspace': 'By folder',
  'groupBy.flat': 'All in one list',
...
export const zhTW = {
  ...
  'search.pending': '正在搜尋工作階段紀錄…',
  'search.unavailable': '內容搜尋暫時無法使用，僅顯示名稱相符的結果。',
  'search.noMatches': '沒有符合的工作階段',
  ...
  'delete.desc': '將把「{name}」從工作區清單中移除。資料夾與工作階段紀錄會保留，其工作階段將顯示在「未分組」下。',
  'delete.pending': '正在刪除工作區…',
  'menu.fork': '分叉工作階段',
  'menu.archiveSession': '封存工作階段',
  ...
  'status.planReview': '計畫待審核',
  'status.waitingAnswer': '等待回覆',
  'status.completed': '已完成',
...
export const ja = {
  ...
  'groupBy.label': 'グループ化',
  'groupBy.workspace': 'フォルダー別',
  'groupBy.flat': 'ひとつのリストに',
  'orderBy.label': '並び順',
  'orderBy.manual': '手動',
  ...
  'search.unavailable': 'コンテンツ検索は一時的に利用できません。名前が一致するものを表示しています。',
  'search.noMatches': '一致するセッションはありません',
  'search.hasMore': '最初の {n} 件のみ表示しています。検索条件を絞り込んでください。',
  ...
  'delete.desc': '「{name}」をワークスペース一覧から削除します。フォルダとセッションのログは保持され、そのセッションは「未分類」に表示されます。',
  ...
  'actions.newSession.aria': '「{name}」で新しいセッション',
  'status.running': '実行中',
