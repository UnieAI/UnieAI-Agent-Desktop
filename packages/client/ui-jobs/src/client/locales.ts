...
/** Traditional Chinese dictionary, key-identical to the Chinese source of truth. */
export const zhTW: Record<JobKey, string> = {
...
export const ja: Record<JobKey, string> = {
  'count.live.one': 'バックグラウンドタスク {count} 件が実行中',
  'count.live.other': 'バックグラウンドタスク {count} 件が実行中',
  'count.idle.one': 'バックグラウンドタスク {count} 件',
  'count.idle.other': 'バックグラウンドタスク {count} 件',
