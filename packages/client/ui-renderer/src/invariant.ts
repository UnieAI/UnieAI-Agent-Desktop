/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-renderer`.
 * @module @unieai/uad-client-ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-renderer'
