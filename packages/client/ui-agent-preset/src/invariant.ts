/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-agent-preset`.
 * @module @unieai/uad-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-agent-preset'
