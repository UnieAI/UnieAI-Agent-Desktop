/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-slots`.
 * @module @unieai/uad-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-slots'
