 ...
 * @module @unieai/uad-client-modules
 */
...
import type { IndexInjection } from '@unieai/uad-host-webserver'
...
const CLIENT_MODULES_ID = '@unieai/uad-client-modules'

/** Dynamic package whose ordinary client bundle must be registered before plugin boot starts. */
const CLIENT_RUNTIME_ID = '@unieai/uad-client-runtime'
