/**
 * Package-owned invariant companion for `@unieai/uad-client-unieai-bootstrap`.
 * @module @unieai/uad-client-unieai-bootstrap/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-unieai-bootstrap'
