...
export const zh = {
  ...
  'skills.group.account': '你的 UnieAI 账号',
  'skills.accountLoading': '正在读取账号里的技能…',
  'skills.accountSignedOut': '登录 UnieAI 后，可以把账号里的技能复制到这台机器。',
  'skills.accountFailed': '读不到你账号里的技能。',
  'skills.accountEmpty': '你的 UnieAI 账号里还没有技能。',
  'skills.accountAttachments': '这个技能在账号里还带了附加文件，复制过来的只有技能本文。',
  'skills.copy': '复制到这台机器',
  'skills.copyAgain': '再复制一次',
  'skills.replace': '覆盖同名技能',
  'skills.copying': '复制中…',
  'skills.userOnly': '仅用户',
  'skills.detail.whenToUse': '什么时候用',
  'skills.detail.file': '文件',
  'skills.detail.source': '来源',
  'skills.detail.modelHidden': '模型看不到这个技能，只有你能用 /名称 调用。',
  'skills.close': '关闭',
  'skills.open': '打开文件',
...
export const zhTW = {
  ...
  'skills.group.account': '你的 UnieAI 帳號',
  'skills.accountLoading': '正在讀取帳號裡的技能…',
  'skills.accountSignedOut': '登入 UnieAI 之後，就能把帳號裡的技能複製到這台機器。',
  'skills.accountFailed': '讀不到你帳號裡的技能。',
  'skills.accountEmpty': '你的 UnieAI 帳號裡還沒有技能。',
  'skills.accountAttachments': '這個技能在帳號裡還帶了附加檔案，複製過來的只有技能本文。',
  'skills.copy': '複製到這台機器',
  'skills.copyAgain': '再複製一次',
  'skills.replace': '覆蓋同名技能',
  'skills.copying': '複製中…',
  'skills.userOnly': '僅使用者',
  'skills.detail.whenToUse': '什麼時候用',
  'skills.detail.file': '檔案',
  'skills.detail.source': '來源',
  'skills.detail.modelHidden': '模型看不到這個技能，只有你能用 /名稱 呼叫。',
  'skills.close': '關閉',
  'skills.open': '開啟檔案',
...
export const ja = {
  ...
  'skills.group.account': 'あなたの UnieAI アカウント',
  'skills.accountLoading': 'アカウントのスキルを読み込んでいます…',
  'skills.accountSignedOut': 'UnieAI にサインインすると、アカウントのスキルをこのマシンにコピーできます。',
  'skills.accountFailed': 'アカウントのスキルを読み取れませんでした。',
  'skills.accountEmpty': 'UnieAI アカウントにはまだスキルがありません。',
  'skills.accountAttachments': 'このスキルはアカウント側に追加ファイルを持っています。コピーされるのは本体だけです。',
  'skills.copy': 'このマシンにコピー',
  'skills.copyAgain': 'もう一度コピー',
  'skills.replace': 'ここにあるものを置き換える',
  'skills.copying': 'コピー中…',
  'skills.userOnly': 'ユーザー専用',
  'skills.detail.whenToUse': '使いどころ',
  'skills.detail.file': 'ファイル',
  'skills.detail.source': '提供元',
  'skills.detail.modelHidden': 'モデルからは見えません。/名前 で自分だけが呼び出せます。',
  'skills.close': '閉じる',
  'skills.open': 'ファイルを開く',
...
export const en = {
  ...
  'skills.group.account': 'YOUR UNIEAI ACCOUNT',
  'skills.accountLoading': 'Reading the skills on your account…',
  'skills.accountSignedOut': 'Sign in to UnieAI to copy the skills on your account onto this machine.',
  'skills.accountFailed': 'The skills on your UnieAI account could not be read.',
  'skills.accountEmpty': 'Your UnieAI account has no skills yet.',
  'skills.accountAttachments': 'This skill carries extra files on the account; a copy brings the skill body only.',
  'skills.copy': 'Copy to this machine',
  'skills.copyAgain': 'Copy again',
  'skills.replace': 'Replace the one here',
  'skills.copying': 'Copying…',
  'skills.userOnly': 'user only',
  'skills.detail.whenToUse': 'When to use it',
  'skills.detail.file': 'File',
  'skills.detail.source': 'Source',
  'skills.detail.modelHidden': 'The model cannot see this skill; only you can call it with /name.',
  'skills.close': 'Close',
