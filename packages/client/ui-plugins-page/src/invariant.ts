/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-client-ui-plugins-page`.
 * @module @deepseek-ai/dsh-client-ui-plugins-page/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-plugins-page'
