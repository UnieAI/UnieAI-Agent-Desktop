/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-brand-official`.
 * @module @unieai/uad-client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-brand-official'
