...
- **Nothing announces a completion in the TUI** — this is a browser package. A turn finishing under `rabi` on a terminal reaches no notification and plays no cue.
