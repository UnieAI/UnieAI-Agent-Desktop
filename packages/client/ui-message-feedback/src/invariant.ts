/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-message-feedback`.
 * @module @unieai/uad-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-message-feedback'
