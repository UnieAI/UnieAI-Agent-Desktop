 ...
 * @module @unieai/uad-client-ui-message-feedback/client/controller
 */

import type { RemoteResult } from '@unieai/uad-typert-protocol'
import type { HostObservable } from '@unieai/uad-client-ui-slots'
import type { MessageId, SessionId } from '@unieai/uad-client-connection/client'
import type {
...
} from '@unieai/uad-message-feedback/types'
