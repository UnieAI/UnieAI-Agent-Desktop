...
import { ConversationEventRegistry } from '@unieai/uad-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@unieai/uad-goal/client'
