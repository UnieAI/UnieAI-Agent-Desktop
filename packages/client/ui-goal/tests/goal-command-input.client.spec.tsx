...
import { ConversationNodeAssembler } from '@unieai/uad-client-runtime/client'
...
import type { SessionEvent } from '@unieai/uad-session/types'
import { commandDefinition } from '@unieai/uad-client-ui-conversation/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from '@unieai/uad-client-ui-conversation/src/client/conversation-nodes/chat-snapshot-builder.ts'
