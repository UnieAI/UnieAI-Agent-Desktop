...
import type { GoalProjection, GoalRef } from '@unieai/uad-goal/client'
...
import { en, ja, zh, zhTW, type GoalKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { 'zh-CN': zh, 'zh-TW': zhTW, ja, en }), 'ui-goal: dictionaries')
