...
import type { GoalSnapshot } from '@unieai/uad-goal/client'
import {
...
export type GoalDockProps = import('@unieai/uad-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
