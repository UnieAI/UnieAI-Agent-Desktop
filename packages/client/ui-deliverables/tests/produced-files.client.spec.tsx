...
import { apply as applyLocale, inject as localeInject } from '@unieai/uad-client-locale/client'
import type { ChatFileMentions, TurnTailOwnerProps } from '@unieai/uad-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@unieai/uad-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@unieai/uad-client-ui-deliverables'])
