/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-deliverables`.
 * @module @unieai/uad-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-deliverables'
