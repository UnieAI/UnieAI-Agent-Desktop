 ...
 * not built (`pnpm --filter @unieai/uad-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@unieai/uad-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@unieai/uad-client-runtime/client', await import('@unieai/uad-client-runtime/client')],
      ['@unieai/uad-client-ui-primitives', await import('@unieai/uad-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@unieai/uad-client-locale/client')
