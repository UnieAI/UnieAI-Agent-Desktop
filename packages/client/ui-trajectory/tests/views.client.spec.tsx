...
import type { ConvViewProps, ViewTab } from '@unieai/uad-client-ui-conversation/client'
import {
  ConversationSession, ConversationSessionHeader,
  type ConversationSessionHeaderProps, type ConversationSessionProps,
} from '@unieai/uad-client-ui-conversation/src/client/skeleton/ConversationSession.tsx'
import { createChatStore } from '@unieai/uad-client-ui-conversation/src/client/stores.ts'
import { zh as conversationZh } from '@unieai/uad-client-ui-conversation/src/client/locales.ts'
import { apply as localeApply, inject as localeInject } from '@unieai/uad-client-locale/client'
import { stubSettingsScope } from '@unieai/uad-client-test-runtime'
import type { LocaleKeysOf } from '@unieai/uad-client-ui-slots'
import { zh, type TrajectoryKey } from '../src/client/locales.ts'
import { apply, inject } from '@unieai/uad-client-ui-trajectory/client'
import { apply as nodeApply } from '@unieai/uad-client-ui-trajectory'
