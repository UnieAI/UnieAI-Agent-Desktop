/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-trajectory`.
 * @module @unieai/uad-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-trajectory'
