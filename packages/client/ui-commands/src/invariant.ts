/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-commands`.
 * @module @unieai/uad-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-commands'
