/**
 * Package-owned invariant companion for `@unieai/uad-client-unieai-account-gateway`.
 * @module @unieai/uad-client-unieai-account-gateway/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-unieai-account-gateway'
