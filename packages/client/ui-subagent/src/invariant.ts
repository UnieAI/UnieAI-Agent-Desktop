/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-subagent`.
 * @module @unieai/uad-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-subagent'
