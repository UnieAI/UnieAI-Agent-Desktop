/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-primitives`.
 * @module @unieai/uad-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-primitives'
