/**
 * Package-owned invariant companion for `@unieai/uad-client-connection`.
 * @module @unieai/uad-client-connection/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-connection'
