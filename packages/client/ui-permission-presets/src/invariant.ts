/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-permission-presets`.
 * @module @unieai/uad-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-permission-presets'
