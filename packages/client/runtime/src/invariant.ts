/**
 * Package-owned invariant companion for `@unieai/uad-client-runtime`.
 * @module @unieai/uad-client-runtime/invariant
 */
...
import type { SlotMap } from '@unieai/uad-client-ui-slots'
import type { InvariantInstaller } from '@unieai/uad-invariants'

const PACKAGE_NAME = '@unieai/uad-client-runtime'
