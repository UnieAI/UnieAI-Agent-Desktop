/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-layout`.
 * @module @unieai/uad-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-layout'
