...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@unieai/uad-client-ui-theme/client'
import { apply, inject, LayoutController } from '@unieai/uad-client-ui-layout/client'
import { apply as nodeApply } from '@unieai/uad-client-ui-layout'
import * as invariant from '@unieai/uad-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@unieai/uad-client-ui-layout', expect.any(Function))
