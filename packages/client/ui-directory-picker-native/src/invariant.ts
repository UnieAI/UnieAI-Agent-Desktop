/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-directory-picker-native`.
 * @module @unieai/uad-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-directory-picker-native'
