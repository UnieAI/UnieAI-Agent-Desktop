...
import type { ToolResultView } from '@unieai/uad-api-remotes/client'
...
import type { ToolCallOwnerProps } from '@unieai/uad-client-ui-tool/client'
import { IconGlobeOutline14 } from '@unieai/uad-client-ui-primitives'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@unieai/cordis').Context
