/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-reference`.
 * @module @unieai/uad-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-reference'
