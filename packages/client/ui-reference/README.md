# `@unieai/uad-client-ui-reference`
...
Indirectly, through `@unieai/uad-file-reference-local` for path guidance and `@unieai/uad-session-reference` for prepared session snapshots.
