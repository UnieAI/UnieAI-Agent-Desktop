...
import { isAppendSurfaceEvent, toAssistantBlocks } from '@unieai/uad-client-runtime/client'
import type {} from '@unieai/uad-llm-retry/types'
import type {
...
declare module '@unieai/uad-client-runtime/client' {
