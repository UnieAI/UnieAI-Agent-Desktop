...
import { isReplacementSurfaceEvent } from '@unieai/uad-client-runtime/client'
import type { CompactionCheckpointSource } from '@unieai/uad-compaction/checkpoint'
import type {} from '@unieai/uad-compaction/types'
import type {} from '@unieai/uad-commands/types'
import type { ManualCompactionChatData } from '../contract/chat-nodes.ts'
import { chatNode } from './common.ts'

declare module '@unieai/uad-client-ui-conversation/client' {
