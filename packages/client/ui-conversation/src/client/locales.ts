...
export const zh = {
  ...
  'artifacts.empty': '本次对话还没有写入或修改文件',
  'artifacts.failed': '失败',
...
export const en = {
  ...
  'artifacts.title': 'Produced here',
  'artifacts.empty': 'This conversation has not written or edited a file yet',
...
export const zhTW = {
  ...
  'details.output': '輸出',
  'details.running': '執行中…',
  'artifacts.title': '本次產出',
  'artifacts.empty': '本次對話還沒有寫入或修改檔案',
  'artifacts.failed': '失敗',
  'artifacts.writing': '寫入中…',
  'files.tab': '檔案',
...
export const ja = {
  ...
  'details.output': '出力',
  'details.running': '実行中…',
  'artifacts.title': 'ここでの成果物',
  'artifacts.empty': 'この会話ではまだファイルを書き込み・編集していません',
  'artifacts.failed': '失敗',
  'artifacts.writing': '書き込み中…',
  'files.tab': 'ファイル',
