...
export const zh = {
  ...
  'input.accessMode': '它可以做到哪里，目前：{name}',
...
export const en = {
  ...
  'placeholder.workspace': 'Pick a folder to start',
  ...
  'input.accessMode': 'What it may do, currently: {name}',
  ...
  'panel.files': 'Files',
  'panel.terminal': 'Commands',
  'panel.browser': 'Web',
  'panel.review': 'What it changed',
  ...
  'panel.refresh': 'Read this folder again',
...
export const zhTW = {
  ...
  'input.accessMode': '它可以做到哪裡，目前：{name}',
...
export const ja = {
  ...
  'placeholder.workspace': 'まずフォルダーを選んでください',
  'input.commands': 'コマンド',
  'input.stop': '生成を停止',
  'input.send': 'メッセージを送信',
  'input.voice': '音声入力',
  ...
  'input.accessMode': 'できること、現在: {name}',
