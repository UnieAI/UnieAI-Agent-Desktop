...
import { resolveSlotLabel, type BoundActions } from '@unieai/uad-client-ui-slots'
import {
...
export function apply(ctx: Context): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { 'zh-CN': zh, 'zh-TW': zhTW, ja, en }), 'ui-conversation: dictionaries')
  ...
  slots.register({
    ...
    children: {
      ...
      'conversation.details.tool.annotation': { kind: 'list', scope: 'session' },
    },
    store: chatStore,
