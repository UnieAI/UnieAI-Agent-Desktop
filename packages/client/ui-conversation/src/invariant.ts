/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-conversation`.
 * @module @unieai/uad-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-conversation'
