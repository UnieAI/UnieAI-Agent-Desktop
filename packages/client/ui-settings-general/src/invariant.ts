/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-settings-general`.
 * @module @unieai/uad-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-settings-general'
