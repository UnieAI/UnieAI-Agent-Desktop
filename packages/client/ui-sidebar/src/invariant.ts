/**
 * Package-owned invariant companion for `@unieai/uad-client-ui-sidebar`.
 * @module @unieai/uad-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-client-ui-sidebar'
