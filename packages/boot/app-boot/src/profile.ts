 ...
 * @module @unieai/uad-app-boot/profile
 */
...
export const PROFILE_TEMPLATES: Record<string, readonly string[]> = {
  web: ['@unieai/uad-base', '@unieai/uad-web-app'],
  headless: ['@unieai/uad-base', '@unieai/uad-headless'],
}
 ...
 * `@unieai/uad-base` (and every other in-box bundle) always comes from
