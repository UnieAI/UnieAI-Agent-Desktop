/**
 * @unieai/uad-cmdline — the command line a dsh launcher hands to the app
 * it boots.
 *
 ...
 * verbatim and in argv order. `rabi --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
