/**
 * Package-owned invariant companion for `@unieai/uad-hooks-claude-code`.
 * @module @unieai/uad-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-hooks-claude-code'
