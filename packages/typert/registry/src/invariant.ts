/**
 * Package-owned invariant companion for `@unieai/uad-typert-registry`.
 * @module @unieai/uad-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-typert-registry'
