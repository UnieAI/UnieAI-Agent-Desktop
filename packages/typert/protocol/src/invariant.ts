/**
 * Package-owned invariant companion for `@unieai/uad-typert-protocol`.
 * @module @unieai/uad-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-typert-protocol'
