/**
 * Package-owned invariant companion for `@unieai/uad-jobs-local`.
 * @module @unieai/uad-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-jobs-local'
...
/**
 * No runtime invariant: `@unieai/uad-jobs/invariant` owns per-snapshot identity, status,
