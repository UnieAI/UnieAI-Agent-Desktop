/**
 * Package-owned invariant companion for `@unieai/uad-agent-instructions`.
 * @module @unieai/uad-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-agent-instructions'
