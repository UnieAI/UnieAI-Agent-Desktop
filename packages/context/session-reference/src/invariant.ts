/**
 * Package-owned invariant companion for `@unieai/uad-session-reference`.
 * @module @unieai/uad-session-reference/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-session-reference'
