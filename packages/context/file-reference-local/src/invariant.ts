/**
 * Package-owned invariant companion for `@unieai/uad-file-reference-local`.
 * @module @unieai/uad-file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-file-reference-local'
