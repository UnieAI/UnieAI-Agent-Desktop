/**
 * Package-owned invariant companion for `@unieai/uad-unieai-mcp-supervisor`.
 * @module @unieai/uad-unieai-mcp-supervisor/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-unieai-mcp-supervisor'
