 ...
 *
 * @module @unieai/uad-sdk-jsonrpc-server/server
 */

import type { Context } from '@unieai/cordis'
import { resolve } from 'node:path'
import type { Agent, AgentHandle } from '@unieai/uad-agent'
import { createUserMessage } from '@unieai/uad-llm'
import { carrierKeyOf, type Scoped } from '@unieai/uad-scope'
import { SessionId } from '@unieai/uad-session'
import type SubagentRuntime from '@unieai/uad-subagent'
import type { SubagentRunEndInfo } from '@unieai/uad-subagent'
...
export class HarnessSdkJsonRpcServer {
  ...
  private async createSession(sessionId: string): Promise<SessionRecord> {
    ...
    // (@unieai/uad-agent-presets README, "Composing a child agent").
