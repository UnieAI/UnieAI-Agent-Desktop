 ...
 * plugin (`@unieai/uad-sdk-jsonrpc-server`) and SDK clients share these shapes;
 * `serverInfo.name` stays the wire-stable `deepseek-harness-sdk-runtime`.
 *
 * @module @unieai/uad-sdk-protocol/types
 */

import type { ContentBlock } from '@unieai/uad-llm'
import type { SessionEvent } from '@unieai/uad-session'
import type { SubagentStopReason } from '@unieai/uad-subagent'
