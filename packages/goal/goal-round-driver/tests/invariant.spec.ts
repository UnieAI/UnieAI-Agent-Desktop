...
import * as GoalSessionInvariant from '@unieai/uad-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@unieai/uad-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@unieai/uad-invariants'
import SessionStore, { SessionId, type Session } from '@unieai/uad-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@unieai/uad-goal-round-driver',
    }))
  })
