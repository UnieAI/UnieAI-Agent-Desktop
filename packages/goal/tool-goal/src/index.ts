 ...
 * @module @unieai/uad-tool-goal
 */

import type { Context } from '@unieai/cordis'
import z from '@unieai/schemastery'
import { GoalId } from '@unieai/uad-goal'
import type { GoalRef, GoalView } from '@unieai/uad-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@unieai/uad-llm'
import { defineTool } from '@unieai/uad-tools'
import type { GenericCallView } from '@unieai/uad-tools'
