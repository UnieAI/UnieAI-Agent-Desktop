 ...
 * @module @unieai/uad-headless/startup
 */
...
export function apply(ctx: Context): void {
  ...
  program.action(() => {
    ...
    if (task.trim() === '') program.error('error: a task is required, for example: rabi --profile headless "run the tests"')
