/**
 * @unieai/uad-headless — one-shot direct Agent driver. The bundle patch
...
import type { ModelSelectionRef } from '@unieai/uad-agent'
...
import type {} from '@unieai/uad-cmdline'
