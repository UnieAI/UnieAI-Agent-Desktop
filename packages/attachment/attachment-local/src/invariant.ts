/** Package-owned invariant companion for `@unieai/uad-attachment-local`. @module @unieai/uad-attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@unieai/cordis'
import type { InvariantInstaller } from '@unieai/uad-invariants'

const PACKAGE_NAME = '@unieai/uad-attachment-local'
