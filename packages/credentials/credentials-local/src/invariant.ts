/**
 * Package-owned invariant companion for `@unieai/uad-credentials-local`.
 * @module @unieai/uad-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-credentials-local'
