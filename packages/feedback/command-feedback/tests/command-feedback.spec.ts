...
import SessionStore, { foldSurface, Session, SessionId } from '@unieai/uad-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@unieai/uad-session-telemetry'
...
vi.mock('@unieai/uad-anonymous-user-id', () => ({
...
describe('@unieai/uad-command-feedback registration', () => {
