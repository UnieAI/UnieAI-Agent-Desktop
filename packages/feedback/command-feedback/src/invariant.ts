/**
 * Package-owned invariant companion for `@unieai/uad-command-feedback`.
 * @module @unieai/uad-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-command-feedback'
