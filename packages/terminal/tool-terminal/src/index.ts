 ...
 * @module @unieai/uad-tool-terminal
 */
...
import { TerminalSessionId } from '@unieai/uad-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@unieai/uad-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @unieai/uad-jobs and @unieai/uad-tool-jobs')
