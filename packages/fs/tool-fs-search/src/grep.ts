 ...
 *
 * @module @unieai/uad-tool-fs-search/grep
 */

import type { Context } from '@unieai/cordis'
import { defineTool } from '@unieai/uad-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@unieai/uad-tools'
import type { RetainedItems } from '@unieai/uad-output-retention'
import type { SpillRef } from '@unieai/uad-spill'
