 ...
 * model-facing render consumes ({@link module:@unieai/uad-tool-fs-search/search-core}
 ...
 *
 * @module @unieai/uad-tool-fs-search/presentation
 */
 ...
 * ({@link module:@unieai/uad-tool-fs-search/grep} `formatGrepMatches`), so
