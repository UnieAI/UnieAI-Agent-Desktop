/**
 * Package-owned invariant companion for `@unieai/uad-tool-str-replace-editor`.
 * @module @unieai/uad-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@unieai/uad-tool-str-replace-editor'
