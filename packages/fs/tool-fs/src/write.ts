 ...
 * @module @unieai/uad-tool-fs/src/write
 */

import type { Context } from '@unieai/cordis'
import { defineTool } from '@unieai/uad-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@unieai/uad-tools'
import type { FsWriteOutcome } from '@unieai/uad-fs'
