import { Context, Service, type Plugin } from '@unieai/cordis'
import type { Dict } from '@unieai/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@unieai/cordis-plugin-loader'
import type { Include } from '@unieai/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@unieai/cordis-plugin-timer'
