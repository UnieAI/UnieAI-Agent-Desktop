...
import type { CordisCatalogModel, ServiceMethodEntry } from '@unieai/uad-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@unieai/uad-tool-cordis/api-catalog', '@unieai/uad-cordis-client-runner/client/api-catalog')
