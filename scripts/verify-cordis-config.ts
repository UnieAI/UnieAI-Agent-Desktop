...
const CHOOSER_PACKAGE = '@unieai/uad-host-directory-picker-auto'
...
const CHOOSER_BACKEND_PACKAGES = [
  '@unieai/uad-host-directory-picker-native',
  '@unieai/uad-host-directory-picker-browse',
  '@unieai/uad-client-ui-directory-picker-browse',
  '@unieai/uad-client-ui-directory-picker-native',
]
const errors: string[] = []
...
function validateEntry(value: unknown, file: string, path: string): void {
  ...
  if (value.name !== '@unieai/cordis-plugin-include') return
