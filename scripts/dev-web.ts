 ...
 * itself (`rabi web`), so any process that rewrites `lib/client.js` files
 ...
 * `lib/client.js`, and `vite build` rewrites `apps/web/dist`, which `rabi web`
...
/** Compile-shell workspace whose dist `rabi web` serves. */
const SHELL_PACKAGE = '@unieai/uad-web-frontend'
