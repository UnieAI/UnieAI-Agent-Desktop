...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  'machines/changed': 'client-face execution-world signal — packages/client/ui-machines/README.md owns the API',
  ...
  'workspaces/new-session': 'client-face New Session outcome signal — packages/client/runtime/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ConnectorProvider: 'one external service and how connecting to it works is owned by packages/connector/connector/README.md, beside the flow that runs it',
  ConnectorStatus: 'a connector as a surface lists it — connected, whose account, what was granted — is owned by packages/connector/connector/README.md',
  ...
  WebGuard:
    'request-guard contract is owned by packages/host/webserver/src/index.ts',
