...
const REPOSITORY_URL = 'https://github.com/unieai/deepseek-harness'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/unieai/deepseek-harness/${repositoryRef}/${path}${suffix}`
