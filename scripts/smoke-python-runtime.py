...
- id: sdk-jsonrpc-server
  name: '@unieai/uad-sdk-jsonrpc-server'
- id: agent-core
...
- id: sessions
  ...
  config:
    ...
    compression: 'none'
- id: code-runtime
  name: '@unieai/uad-code-runtime-worker-thread'
- id: subagents
  name: '@unieai/uad-subagent'
- id: subagent-spawn-in-process
  name: '@unieai/uad-subagent-spawn-in-process'
  config:
    providerName: spawn
- id: subagent-tool
...
- id: cordis-host-runner
  name: '@unieai/uad-cordis-host-runner'
- id: cordis-tool
  name: '@unieai/uad-tool-cordis'
"""
FS_SEARCH_CORDIS = """\
- id: sdk-jsonrpc-server
  name: '@unieai/uad-sdk-jsonrpc-server'
...
- id: fs-search
  name: '@unieai/uad-tool-fs-search'
  config:
